...
public class Country implements Serializable {
    ...
    @Expose
    private String cioc;
    private final static long serialVersionUID = 2334848023469863869L;
     ...
     * @param isFav
     */
    public Country(String name, List<String> topLevelDomain, String alpha2Code, String alpha3Code, List<String> callingCodes, String capital, List<String> altSpellings, String region, String subregion, int population, List<Double> latlng, String demonym, double area, Object gini, List<String> timezones, List<String> borders, String nativeName, String numericCode, List<Currency> currencies, List<Language> languages, Translations translations, String flag, List<RegionalBloc> regionalBlocs, String cioc, boolean isFav) {
        super();
        this.name = name;
